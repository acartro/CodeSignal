...
if __name__ == "__main__":
    ...
    print("The test of matrix = [[0, 1, 1, 2],[0, 5, 0, 0],[2, 0, 3, 3]] is " + str(matrixElementsSum(matrix)))
    matrix=[[1, 1, 1, 0], [0, 5, 0, 1], [2, 1, 3, 10]]
    print("The test of matrix = [[1, 1, 1, 0],[0, 5, 0, 1],[2, 1, 3, 10]] is " + str(matrixElementsSum(matrix)))
